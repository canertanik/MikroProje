      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        <div className="relative overflow-hidden rounded-lg bg-white p-5 shadow-sm border border-gray-100">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Satışlar (Seçili Dönem)</p>
          </dt>
        ...
        <div className="relative overflow-hidden rounded-lg bg-white p-5 shadow-sm border border-gray-100">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Satın Almalar (Seçili Dönem)</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
        ...
        <div className="relative overflow-hidden rounded-lg bg-white p-5 shadow-sm border border-gray-100">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Toplam Müşteri Alacağı</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
      ...
      <div className="grid grid-cols-1 gap-5 sm:grid-cols-2 lg:grid-cols-4">
        ...
        >
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Bekleyen Alımlar</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
        ...
        >
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Draft Transferler</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
        ...
        <div className="relative overflow-hidden rounded-lg bg-white p-5 shadow-sm border border-gray-100">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Borçlu Müşteriler</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
        ...
        <div className="relative overflow-hidden rounded-lg bg-white p-5 shadow-sm border border-gray-100">
          <dt>
            ...
            <p className="ml-16 truncate text-sm font-medium text-gray-500">Alacaklı Tedarikçiler</p>
          </dt>
          <dd className="ml-16 flex items-baseline pb-1">
